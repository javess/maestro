...
| STEP-006 | Approval gate framework | done | 2026-04-05 13:00 UTC | [STEP-006](steps/STEP-006.md) | pending post-commit recording | targeted approval pass; `ruff` pass; `ty` pass; `pytest` pass; `eval` pass; UI build pass | Request confirmation before `STEP-007` |
